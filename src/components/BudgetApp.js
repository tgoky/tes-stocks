    ...
    return (
        <div id="main-content">
            <form id="form" className="budget">
                <h1>Tesla Hedge Stocks</h1>
                <div>The Fastest ROI Yield Passive Income Investment</div>

                <div id="budget">
                    <div className="budget-menu">
                        <div>
                            <button className="btn2" onClick={addBudget}><i className='bx bx-book-add'></i> Add Stocks</button>
                        </div>
                        <div>
                          <label>Remaining Budget </label>
                          
                          <h1 className={ currentBalance < 0 ? 'danger' : '' }>{dollar}{formatNumber(currentBalance)}</h1>
                        </div>
                    </div>
